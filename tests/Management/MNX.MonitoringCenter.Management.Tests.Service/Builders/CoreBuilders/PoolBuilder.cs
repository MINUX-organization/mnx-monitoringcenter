...
public class PoolBuilder
{
    ...
    public PoolBuilder WithCryptocurrency(Func<CryptocurrencyBuilder, CryptocurrencyBuilder>? configure = null)
    {
    ...
    public PoolBuilder WithCryptocurrency(Cryptocurrency cryptocurrency)
    {
