...
('deroluna-miner', '1.14', 'Single', 4+16, 'Integrated', 'https://github.com/DeroLuna/dero-miner/releases/download/v1.14/deroluna-v1.14_linux_hiveos_mmpos.tar.gz'),

('xmrig', '6.22.2', 'Single', 4+16, 'Integrated', 'https://github.com/xmrig/xmrig/releases/download/v6.22.2/xmrig-6.22.2-linux-static-x64.tar.gz'),
...
('wildrig-multi', '0.42.2', 'Single', 1+2+8, 'Integrated', 'https://github.com/andru-kun/wildrig-multi/releases/download/0.42.2/wildrig-multi-linux-0.42.2.tar.xz'),

('t-rex', '0.26.8', 'Dual', 1, 'Integrated', 'https://github.com/trexminer/T-Rex/releases/download/0.26.8/t-rex-0.26.8-linux.tar.gz'),
...
('teamredminer', '0.10.21', 'Triple', 8, 'Integrated', 'https://github.com/todxx/teamredminer/releases/download/v0.10.21/teamredminer-v0.10.21-linux.tgz'),
...
('SRBMiner-MULTI', '2.7.6', 'Triple', 1+2+4+8+16, 'Integrated', 'https://github.com/doktor83/SRBMiner-Multi/releases/download/2.7.6/SRBMiner-Multi-2-7-6-Linux.tar.gz'),
...
('rigel', '1.20.1', 'Triple', 1, 'Integrated', 'https://github.com/rigelminer/rigel/releases/download/1.20.1/rigel-1.20.1-linux.tar.gz'),
...
('onezerominer', '1.4.3', 'Dual', 1, 'Integrated', 'https://github.com/OneZeroMiner/onezerominer/releases/download/v1.4.3/onezerominer-linux-1.4.3.tar.gz'),
...
('lolMiner', '1.94a', 'Dual', 1+2+8, 'Integrated', 'https://github.com/Lolliedieb/lolMiner-releases/releases/download/1.94a/lolMiner_v1.94a_Lin64.tar.gz'),

('gminer', '3.44', 'Single', 1+8, 'Integrated', 'https://github.com/develsoftware/GMinerRelease/releases/download/3.44/gminer_3_44_linux64.tar.xz'),
