namespace MNX.MonitoringCenter.Inventory.UseCases.Devices.Motherboard;
...
public interface IMotherboardRepository
{
    ...
    Task<Contracts.Devices.Motherboard.Motherboard?> GetMotherboardByRigId(Guid rigId, Guid userId,
