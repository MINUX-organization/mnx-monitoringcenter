...
namespace MNX.MonitoringCenter.Inventory.UseCases.RigInventory.Devices.Drive;
...
public interface IDriveRepository
{
    ...
    Task<List<Contracts.Drive.Drive>?> GetDrives(InventorySpecification specification,
    ...
    Task<int> GetDrivesCount(DeviceSpecification specification, CancellationToken cancellationToken);
}
