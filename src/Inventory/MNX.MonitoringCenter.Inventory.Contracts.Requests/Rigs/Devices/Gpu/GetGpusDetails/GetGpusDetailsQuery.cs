...
/// <summary>
/// Запрос на получение списка видеокарт с деталями.
/// </summary>
public class GetGpusDetailsQuery : IStreamRequest<GpuDetails>
{
    /// <summary>
    ...
    /// <summary>
    /// Создаёт экземпляр класса <see cref="GetGpusDetailsQuery"/>.
    /// </summary>
    ...
    public GetGpusDetailsQuery(Guid userId, Guid[]? rigsIds = null, string[]? models = null, string[]? manufacturers = null)
    {
    ...
    public GetGpusDetailsQuery(Guid userId, Guid rigId, string[]? models = null, string[]? manufacturers = null)
    {
